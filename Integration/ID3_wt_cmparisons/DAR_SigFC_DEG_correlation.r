...
#merge data
merged <- list()
for(i in names(DAR_list_complete_sign_fc)){
    temp <- inner_join(as.data.frame(DAR_list_complete_sign_fc[[i]]),as.data.frame(DEG_results_list[[i]]), by="ENSEMBL")
    temp$Col <- NA
...
pdf(file.path(output.dir, i , "DAR_RNA_allSigFcDARs_allGenes_nolabel.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()

pdf(file.path(output.dir, i , "DAR_RNA_Heat_allSigFcDARs_allGenes_nolabel.pdf"), width=6,height=6)
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_PromoterSigFcDARs_allGenes_nolabel.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()

pdf(file.path(output.dir, i , "DAR_RNA_Heat_PromoterSigFcDARs_allGenes_nolabel.pdf"), width=6,height=6)
heatscatter(merged_sub[[i]]$log2FoldChange, merged_sub[[i]]$Fold,
    cexplot = .2,
    xlab=paste0("\nGene expression change\n[log2foldchange]","\n",name),
    ylab=paste0("Chromatin accessibility change\n[log2foldchange]","\n",name),
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_allSigFcDARs_allSigGenes_nolabel.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()

pdf(file.path(output.dir, i , "DAR_RNA_Heat_allSigFcDARs_allSigGenes_nolabel.pdf"), width=6,height=6)
heatscatter(merged_sub[[i]]$log2FoldChange, merged_sub[[i]]$Fold,
    cexplot = .2,
    xlab=paste0("\nGene expression change\n[log2foldchange]","\n",name),
    ylab=paste0("Chromatin accessibility change\n[log2foldchange]","\n",name),
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_PromoterSigFcDARs_allSigGenes_nolabel.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_PromoterSigFcDARs_allSigGenes_label2.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()

pdf(file.path(output.dir, i , "DAR_RNA_Heat_PromoterSigFcDARs_allSigGenes_nolabel.pdf"), width=6,height=6)
heatscatter(merged_sub[[i]]$log2FoldChange, merged_sub[[i]]$Fold,
    cexplot = .2,
    xlab=paste0("\nGene expression change\n[log2foldchange]","\n",name),
    ylab=paste0("Chromatin accessibility change\n[log2foldchange]","\n",name),
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_allSigFcDARs_allSigFCGenes_nolabel.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()

pdf(file.path(output.dir, i , "DAR_RNA_Heat_allSigFcDARs_allSigFCGenes_nolabel.pdf"), width=6,height=6)
heatscatter(merged_sub[[i]]$log2FoldChange, merged_sub[[i]]$Fold,
    cexplot = .2,
    xlab=paste0("\nGene expression change\n[log2foldchange]","\n",name),
    ylab=paste0("Chromatin accessibility change\n[log2foldchange]","\n",name),
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_PromoterSigFcDARs_allSigFCGenes_nolabel.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()
...
dir.create(file.path(output.dir,i))
pdf(file.path(output.dir, i , "DAR_RNA_PromoterSigFcDARs_allSigFCGenes_label2.pdf"), width=4,height=4)
    print(g[[i]])
dev.off()

pdf(file.path(output.dir, i , "DAR_RNA_Heat_PromoterSigFcDARs_allSigFCGenes_nolabel.pdf"), width=6,height=6)
heatscatter(merged_sub[[i]]$log2FoldChange, merged_sub[[i]]$Fold,
    cexplot = .2,
    xlab=paste0("\nGene expression change\n[log2foldchange]","\n",name),
    ylab=paste0("Chromatin accessibility change\n[log2foldchange]","\n",name),
