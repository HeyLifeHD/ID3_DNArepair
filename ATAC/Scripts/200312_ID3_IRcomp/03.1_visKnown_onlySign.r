...
knownRes <- list.files(file.path(analysis.dir, "homer_onlySig"), pattern="knownResults$", full.names = TRUE, recursive = TRUE, include.dirs= TRUE)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer_onlySig",i, paste0("HomerBubble_all_qval0.05.pdf")), height=40)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer_onlySig", i,paste0("HomerBubble_top10_qval0.05.pdf")))
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer_onlySig",i, paste0("HomerBubble_all_qval0.05_vsBG.pdf")), height=40)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
    }
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer", i,paste0("HomerBubble_top10_qval0.05_vsBG.pdf")))
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
    }
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined/homer", paste0("combined_",i,"_HomerBubble_all_qval0.05.pdf")), height=45, width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
}
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined/homer", paste0("combined_",i,"_HomerBubble_top10_qval0.05.pdf")), width=12)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "medecom/downstream_combined/homer", paste0("combined_",i,"_HomerBubble_top5_qval0.05.pdf")), width=9)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i)+
