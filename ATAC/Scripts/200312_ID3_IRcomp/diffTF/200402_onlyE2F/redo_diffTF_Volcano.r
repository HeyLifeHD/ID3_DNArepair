...
diffTF_res_Irr_plot[which(diffTF_res_Irr_plot$pvalueAdj >0.05),]$Plot <- NA 
...
pdf(file.path("/home/heyj/c010-datasets/Internal/2018-Ali/ATAC/200312_ID3_IRcomp/analysis/diffTF/200402_output_all_anl/FINAL_OUTPUT/",  "Redone_volcanoe_E2F_highlight2.pdf"), width=4,height=4)
print(g)
dev.off()
