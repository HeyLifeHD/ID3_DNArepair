...
base_UnIrr.dir<- "/home/heyj/c010-datasets/Internal/2018-Ali/RNASeq/190930_odcf/id3_wo_irr_4rep"
data_UnIrr.dir <- file.path(base_UnIrr.dir, "data")
base_results_UnIrr.dir <- file.path(base_UnIrr.dir, "results")
results_UnIrr.dir<- file.path(base_results_UnIrr.dir , "tables")
PreDE_UnIrr.dir <- file.path(base_results_UnIrr.dir,"PreDE")
PostDE_UnIrr.dir <- file.path(base_results_UnIrr.dir,"PostDE")
...
#RNA
#Irr
DEG_results_list<- readRDS(file.path(PostDE_UnIrr.dir,  "DEG_results_group_list.rds"))
...
ID3KO_Irr_vs_WT_Irr <- DEG_results_list$ID3_Irr.UNTREATED_Tam.UNTREATED_Hdac.UNTREATED_vs_WT_Irr.UNTREATED_Tam.UNTREATED_Hdac.UNTREATED
...
pdf(file.path("/home/heyj/c010-datasets/Internal/2018-Ali/ATAC/200312_ID3_IRcomp/analysis/diffTF/200402_output_all_unIrr_anal/FINAL_OUTPUT/",  "MeanTargetGeneExpression_TFactivity_correlation_onlyPromoter.pdf"), width=7,height=7)
print(g)
dev.off()
...
pdf(file.path("/home/heyj/c010-datasets/Internal/2018-Ali/ATAC/200312_ID3_IRcomp/analysis/diffTF/200402_output_all_unIrr_anal/FINAL_OUTPUT/",  "MeanTargetGeneExpression_TFactivity_correlation_onlyPromoter_onlyE2F.pdf"), width=5,height=5)
print(g)
dev.off()
