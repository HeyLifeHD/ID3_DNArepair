...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer",i, paste0("HomerBubble_all_qval0.05.pdf")), height=40)
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer", i,paste0("HomerBubble_top10_qval0.05.pdf")))
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
...
for (i in names(DAR_list)){
    ...
    pdf(file.path(analysis.dir, "homer",i, paste0("HomerBubble_all_qval0.05_vsBG.pdf")), height=40)
    print(bubblePlot(DAR_list_sub_plot[[i]])+ggtitle(i))
    dev.off()
    }
