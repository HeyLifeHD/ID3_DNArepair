...
anno <- colData(dds)
dds_sub <- dds[,anno$genotype =="ARID1A"]
...
saveRDS(vst_genes,file = file.path(results.dir,"ARID1A_sub_vst_genes.rds"))
...
pdf(file.path(PreDE.dir, "ARID1Asub_PCA12_genes.pdf"), height = 4, width = 10)
...
pdf(file.path(PreDE.dir, "ARID1Asub_PCA23_genes.pdf"), height = 7, width = 10)
...
pdf(file.path(PreDE.dir, "ARID1Asub_Clustering_vst_genes.pdf"), height = 7, width = 7)
...
saveRDS(vst_genes_b,file =file.path(results.dir, "ARID1Asub_vst_genes_b_replicate.rds"))
...
pdf(file.path(PreDE.dir, "ARID1Asub_PCA12_afB.pdf"), height = 7, width = 10)
...
pdf(file.path(PreDE.dir, "ARID1Asub_PCA23_afB.pdf"), height = 4, width = 5)
