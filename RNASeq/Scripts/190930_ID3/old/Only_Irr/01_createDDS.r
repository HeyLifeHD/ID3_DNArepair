...
base.dir<- "/home/heyj/c010-datasets/Internal/2018-Ali/RNASeq/190930_odcf/Only_Irr"
dir.create(base.dir)
...
counts <- counts_list[["OnlyIrradiated"]]
sample_anno_list <- readRDS(file.path(data.dir, "sample_anno_list.rds"))
sample_anno <- sample_anno_list[["OnlyIrradiated"]]
