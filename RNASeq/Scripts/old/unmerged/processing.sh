...
cd /icgc/dkfzlsdf/analysis/C010/id3/190228_RNAseq_processing/
#start pipeline
/icgc/dkfzlsdf/analysis/C010/nextflow/nextflow run /icgc/dkfzlsdf/analysis/C010/nextflow/rnaseq-master/main.nf  --saveTrimmed --saveAlignedIntermediates --genome Hg19 -profile cluster_odcf -resume --skip_genebody_coverage
